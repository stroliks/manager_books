...
def msg_offer_create_or_use_test_catalog():
    print()
    print("Каталог отсутствует! Необходимо создание нового каталога либо возможно использование тестового\n"
          "Пожалуйста, нажмите: \n"
...
def empty_reestr():
    print()
    print("Еще ни одного каталога не создавалось. Создайте каталог либо используйте тестовый\n"
